const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.host': 'SMTP Szerver',
  'admin.smtp.port': 'SMTP Port',
  'admin.smtp.user': 'SMTP Felhasználó',
  'admin.smtp.pass': 'SMTP Jelszó',
  'admin.smtp.from': 'Feladó cím',
  'admin.smtp.skipTls': 'TLS tanúsítvány ellenőrzés kihagyása',
  'admin.smtp.skipTlsHint': 'Engedélyezze önálló aláírású tanúsítványok esetén helyi levelező szervereken',
  ...
  'login.inviteExpired': 'Érvénytelen vagy lejárt meghívó link',
  ...
  'admin.oidcDisplayNamePlaceholder': 'pl. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'Felderítési URL',
  'admin.oidcDiscoveryUrlOptional': 'Felderítési URL (nem kötelező)',
  'admin.oidcDiscoveryUrlHint': 'Felülírja az automatikusan létrehozott felderítési URL-t. Szükséges az Authentik-hoz hasonló szolgáltatóknál.',
  ...
  // Fotók
  'photos.title': 'Fényképek',
  'photos.count': '{count} fénykép',
  'photos.countPlural': '{count} fénykép',
  'photos.countFor': '{count} fénykép ehhez: {trip}',
  ...
  'collab.chat.geminiExecute': 'Gemini végrehajtsa',
  'collab.chat.geminiCommandHint': 'A Gemini végrehajtása küldés után kezdődik. Válaszolj egy üzenetre, hogy forrásötletként használd.',
  'collab.chat.template.dayFlow': 'Napi terv',
  'collab.chat.template.dayFlowPrompt': 'Tervezd meg a mai napot áttekinthető ütemtervként időablakokkal, helyszínekkel és 1 tartalék opcióval.',
  'collab.chat.template.budgetPass': 'Költségvetés',
  'collab.chat.template.budgetPassPrompt': 'Készíts egy tömör költségvetést a legfontosabb tételekkel, kategóriákkal és reális árakkal.',
  'collab.chat.template.packingOptimizer': 'Csomagolásoptimalizáló',
  'collab.chat.template.packingOptimizerPrompt': 'Generálj egy prioritizált csomagolólistát az időjárás, tevékenységek és az utazás hossza alapján mennyiségekkel.',
  'collab.chat.template.mapExpansion': 'Térkép bővítése',
  'collab.chat.template.mapExpansionPrompt': 'Keress 5 megfelelő helyet ehhez az utazáshoz, rangsorold logisztikai közelség szerint, és csak ésszerű jelölteket adj hozzá.',
  ...
  'notifications.count': '{count} értesítés',
  'notifications.countPlural': '{count} értesítés',
