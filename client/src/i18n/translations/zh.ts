const zh: Record<string, string> = {
  ...
  'admin.smtp.host': 'SMTP 服务器',
  'admin.smtp.port': 'SMTP 端口',
  'admin.smtp.user': 'SMTP 用户',
  'admin.smtp.pass': 'SMTP 密码',
  'admin.smtp.from': '发件人地址',
  'admin.smtp.skipTls': '跳过 TLS 证书检查',
  'admin.smtp.skipTlsHint': '对本地邮件服务器上的自签名证书启用',
  ...
  'login.inviteExpired': '邀请链接无效或已过期',
  ...
  'admin.oidcDiscoveryUrl': '发现 URL',
  'admin.oidcDiscoveryUrlOptional': '发现 URL（可选）',
  'admin.oidcDiscoveryUrlHint': '覆盖自动构建的发现 URL。对于 Authentik 等提供商是必要的。',
  ...
  'photos.countPlural': '{count} 张照片',
  'photos.countFor': '{trip} 的 {count} 张照片',
  'photos.linkDay': '关联天数',
  'photos.noDay': '无天数',
  'photos.captionForAll': '说明（全部）',
  'photos.captionPlaceholder': '可选说明...',
  'photos.allDays': '所有天',
  ...
  'collab.chat.geminiExecute': '让 Gemini 执行',
  'collab.chat.geminiCommandHint': 'Gemini 执行在发送后开始。回复消息以将其用作源创意。',
  'collab.chat.template.dayFlow': '日程规划',
  'collab.chat.template.dayFlowPrompt': '将今天规划为清晰的时间表，包含时间段、地点和1个备选方案。',
  'collab.chat.template.budgetPass': '预算',
  'collab.chat.template.budgetPassPrompt': '创建包含最重要费用项目（含类别和实际价格）的简洁预算。',
  'collab.chat.template.packingOptimizer': '行李优化',
  'collab.chat.template.packingOptimizerPrompt': '根据天气、活动和行程长短生成带数量的优先级行李清单。',
  'collab.chat.template.mapExpansion': '地图扩展',
  'collab.chat.template.mapExpansionPrompt': '为这次旅行找5个合适的地点，按物流距离排序，只添加有意义的候选地点。',
  ...
  'notifications.countPlural': '{count} 条通知',
