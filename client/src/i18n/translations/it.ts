const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.host': 'Server SMTP',
  'admin.smtp.port': 'Porta SMTP',
  'admin.smtp.user': 'Utente SMTP',
  'admin.smtp.pass': 'Password SMTP',
  'admin.smtp.from': 'Indirizzo mittente',
  'admin.smtp.skipTls': 'Salta verifica certificato TLS',
  'admin.smtp.skipTlsHint': 'Abilitare per certificati auto-firmati su server di posta locali',
  ...
  'login.inviteExpired': 'Link di invito non valido o scaduto',
  ...
  'admin.oidcDisplayNamePlaceholder': 'es. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'URL di scoperta',
  'admin.oidcDiscoveryUrlOptional': 'URL di scoperta (opzionale)',
  'admin.oidcDiscoveryUrlHint': 'Sostituisce l\'URL di scoperta costruita automaticamente. Necessario per provider come Authentik.',
  ...
  'inspector.activities': 'Attività',
  'inspector.activitiesGenerate': 'Pianifica Attività',
  'inspector.activitiesGenerating': 'Generazione del piano attività…',
  'inspector.activitiesError': 'Impossibile generare il piano attività.',
  'inspector.activitiesRetry': 'Riprova',
  'inspector.activitiesHide': 'Nascondi',
  ...
  'photos.countPlural': '{count} foto',
  'photos.countFor': '{count} foto per {trip}',
  ...
  'collab.chat.geminiExecute': 'Lascia eseguire a Gemini',
  'collab.chat.geminiCommandHint': 'L\'esecuzione di Gemini inizia dopo l\'invio. Rispondi a un messaggio per usarlo come idea sorgente.',
  'collab.chat.template.dayFlow': 'Piano Giornaliero',
  'collab.chat.template.dayFlowPrompt': 'Pianifica la giornata come un programma chiaro con fasce orarie, luoghi e 1 opzione di riserva.',
  'collab.chat.template.budgetPass': 'Budget',
  'collab.chat.template.budgetPassPrompt': 'Crea un budget compatto con le voci di costo più importanti inclusa la categoria e i prezzi realistici.',
  'collab.chat.template.packingOptimizer': 'Ottimizzatore Bagagli',
  'collab.chat.template.packingOptimizerPrompt': 'Genera una lista di imballaggio prioritaria in base a meteo, attività e durata con le quantità.',
  'collab.chat.template.mapExpansion': 'Espansione della Mappa',
  'collab.chat.template.mapExpansionPrompt': 'Trova 5 luoghi adatti a questo viaggio, dai priorità alla vicinanza logistica e aggiungi solo candidati significativi.',
  ...
  'notifications.count': '{count} notifica',
  'notifications.countPlural': '{count} notifiche',
