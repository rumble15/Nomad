const fr: Record<string, string> = {
  ...
  'admin.smtp.user': 'Utilisateur SMTP',
  'admin.smtp.pass': 'Mot de passe SMTP',
  'admin.smtp.from': 'Adresse d\'expéditeur',
  'admin.smtp.skipTls': 'Ignorer la vérification du certificat TLS',
  'admin.smtp.skipTlsHint': 'Activer pour les certificats auto-signés sur les serveurs de messagerie locaux',
  ...
  'login.inviteExpired': 'Lien d\'invitation invalide ou expiré',
  ...
  'admin.oidcDiscoveryUrl': 'URL de découverte',
  'admin.oidcDiscoveryUrlOptional': 'URL de découverte (optionnel)',
  'admin.oidcDiscoveryUrlHint': 'Remplace l\'URL de découverte construite automatiquement. Requis pour les fournisseurs comme Authentik.',
  ...
  'inspector.activities': 'Activités',
  'inspector.activitiesGenerate': 'Planifier les activités',
  'inspector.activitiesGenerating': "Génération du plan d'activités…",
  'inspector.activitiesError': "Impossible de générer le plan d'activités.",
  'inspector.activitiesRetry': 'Réessayer',
  'inspector.activitiesHide': 'Masquer',
  ...
  'photos.countFor': '{count} photos pour {trip}',
  ...
  'collab.chat.template.packingOptimizerPrompt': 'Génère une liste de bagages priorisée selon la météo, les activités et la durée avec les quantités.',
  'collab.chat.template.mapExpansion': 'Extension de la Carte',
  'collab.chat.template.mapExpansionPrompt': 'Trouve 5 endroits adaptés à ce voyage, priorise par proximité logistique et ajoute uniquement des candidats pertinents.',
