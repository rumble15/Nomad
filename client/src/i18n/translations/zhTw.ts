const zhTw: Record<string, string> = {
  ...
  'admin.smtp.host': 'SMTP 伺服器',
  'admin.smtp.port': 'SMTP 連接埠',
  'admin.smtp.user': 'SMTP 使用者',
  'admin.smtp.pass': 'SMTP 密碼',
  'admin.smtp.from': '寄件人地址',
  'admin.smtp.skipTls': '略過 TLS 憑證驗證',
  'admin.smtp.skipTlsHint': '對本機郵件伺服器上的自簽憑證啟用',
  ...
  'login.inviteExpired': '邀請連結無效或已過期',
  ...
  'admin.oidcDisplayNamePlaceholder': '例如 Google、Authentik、Keycloak',
  'admin.oidcDiscoveryUrl': '探索 URL',
  'admin.oidcDiscoveryUrlOptional': '探索 URL（選填）',
  'admin.oidcDiscoveryUrlHint': '覆蓋自動建立的探索 URL。對於 Authentik 等提供者是必要的。',
  ...
  'photos.countPlural': '{count} 張照片',
  'photos.countFor': '{trip} 的 {count} 張照片',
  'photos.linkDay': '關聯天數',
  'photos.noDay': '無天數',
  'photos.captionForAll': '說明（全部）',
  'photos.captionPlaceholder': '可選說明...',
  'photos.allDays': '所有天',
  ...
  'collab.chat.geminiExecute': '讓 Gemini 執行',
  'collab.chat.geminiCommandHint': 'Gemini 執行在傳送後開始。回覆訊息以將其用作源創意。',
  'collab.chat.template.dayFlow': '行程規劃',
  'collab.chat.template.dayFlowPrompt': '將今天規劃為清楚的時間表，包含時段、地點和1個備選方案。',
  'collab.chat.template.budgetPass': '預算',
  'collab.chat.template.budgetPassPrompt': '建立包含最重要費用項目（含類別和實際價格）的精簡預算。',
  'collab.chat.template.packingOptimizer': '行李優化',
  'collab.chat.template.packingOptimizerPrompt': '根據天氣、活動和行程長短產生帶數量的優先行李清單。',
  'collab.chat.template.mapExpansion': '地圖擴展',
  'collab.chat.template.mapExpansionPrompt': '為這次旅行找5個合適的地點，按物流距離排序，只添加有意義的候選地點。',
  ...
  'notifications.count': '{count} 則通知',
  'notifications.countPlural': '{count} 則通知',
