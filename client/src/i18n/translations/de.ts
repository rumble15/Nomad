const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.user': 'SMTP-Benutzer',
  'admin.smtp.pass': 'SMTP-Passwort',
  'admin.smtp.from': 'Absenderadresse',
  'admin.smtp.skipTls': 'TLS-Zertifikatsprüfung überspringen',
  'admin.smtp.skipTlsHint': 'Für selbstsignierte Zertifikate auf lokalen Mailservern aktivieren',
  ...
  'settings.mcp.gemini.title': 'Gemini Co-Worker (gemini-3.1-pro-preview)',
  'settings.mcp.gemini.model': 'Modell',
  'settings.mcp.gemini.clientConfig': 'Gemini MCP-Profilvorlage',
  'settings.mcp.gemini.clientConfigHint': 'Referenzvorlage für Gemini-kompatible MCP-Clients. Je nach Client können die Property-Namen abweichen.',
  'settings.mcp.gemini.alwaysOn': 'Always-On Co-Worker Prompt',
  'settings.mcp.gemini.alwaysOnHint': 'Als Systemanweisung verwenden, damit Gemini die Reise autonom planen, optimieren und dokumentieren kann.',
  'settings.mcp.gemini.taskKickoff': 'Task-Kickoff Prompt',
  'settings.mcp.gemini.taskKickoffHint': 'Als erste Aufgaben-Nachricht verwenden, um eine End-to-End-Ausführung per Function-Calling zu starten.',
  'settings.mcp.gemini.toolsHint': 'Empfohlene Tools: get_trip_summary, maps_search, search_trip sowie create_*/update_*/delete_* für autonome Ausführung.',
  ...
  'login.inviteExpired': 'Ungültiger oder abgelaufener Einladungslink',
  ...
  'admin.oidcDisplayNamePlaceholder': 'z.B. Google, Authentik, Keycloak',
  ...
  'admin.oidcDiscoveryUrlOptional': 'Discovery URL (optional)',
  'admin.oidcDiscoveryUrlHint': 'Überschreibt die automatisch erstellte Discovery URL. Erforderlich für Anbieter wie Authentik, bei denen der Endpunkt nicht unter <Issuer>/.well-known/openid-configuration liegt.',
  ...
  'photos.countPlural': '{count} Fotos',
  'photos.countFor': '{count} Fotos für {trip}',
  ...
  'collab.chat.geminiExecute': 'Von Gemini umsetzen lassen',
  'collab.chat.geminiCommandHint': 'Gemini startet nach dem Senden. Antworte auf eine Nachricht, um sie als Ideenquelle zu nutzen.',
  'collab.chat.template.dayFlow': 'Tagesablauf',
  'collab.chat.template.dayFlowPrompt': 'Plane den heutigen Tag als klaren Ablauf mit Zeitfenstern, Orten und 1 Backup-Option.',
  'collab.chat.template.budgetPass': 'Budget',
  'collab.chat.template.budgetPassPrompt': 'Erstelle ein kompaktes Budget mit den wichtigsten Kostenpunkten inklusive Kategorie und realistischen Preisen.',
  'collab.chat.template.packingOptimizer': 'Packliste',
  'collab.chat.template.packingOptimizerPrompt': 'Erzeuge eine priorisierte Packliste nach Wetter, Aktivitäten und Dauer mit Mengenangaben.',
  'collab.chat.template.mapExpansion': 'Kartenausbau',
  'collab.chat.template.mapExpansionPrompt': 'Finde 5 passende Orte für diese Reise, priorisiere nach logistischer Nähe und füge nur sinnvolle Kandidaten hinzu.',
  ...
  'notifications.count': '{count} Benachrichtigung',
  'notifications.countPlural': '{count} Benachrichtigungen',
