const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.user': 'Usuário SMTP',
  'admin.smtp.pass': 'Senha SMTP',
  'admin.smtp.from': 'Endereço de Remetente',
  'admin.smtp.skipTls': 'Ignorar verificação de certificado TLS',
  'admin.smtp.skipTlsHint': 'Ativar para certificados autoassinados em servidores de e-mail locais',
  ...
  'login.inviteExpired': 'Link de convite inválido ou expirado',
  ...
  'admin.oidcDisplayNamePlaceholder': 'ex. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'URL de descoberta',
  'admin.oidcDiscoveryUrlOptional': 'URL de descoberta (opcional)',
  'admin.oidcDiscoveryUrlHint': 'Substitui a URL de descoberta construída automaticamente. Necessário para provedores como Authentik.',
  ...
  'inspector.activities': 'Atividades',
  'inspector.activitiesGenerate': 'Planejar Atividades',
  'inspector.activitiesGenerating': 'Gerando plano de atividades…',
  'inspector.activitiesError': 'Não foi possível gerar o plano de atividades.',
  'inspector.activitiesRetry': 'Tentar novamente',
  ...
  'photos.countFor': '{count} fotos para {trip}',
  ...
  'collab.chat.geminiExecute': 'Deixar o Gemini executar',
  'collab.chat.geminiCommandHint': 'A execução do Gemini começa após o envio. Responda a uma mensagem para usá-la como ideia de origem.',
  'collab.chat.template.dayFlow': 'Fluxo do Dia',
  'collab.chat.template.dayFlowPrompt': 'Planeje o dia de hoje como um cronograma claro com janelas de tempo, lugares e 1 opção de backup.',
  'collab.chat.template.budgetPass': 'Orçamento',
  'collab.chat.template.budgetPassPrompt': 'Crie um orçamento compacto com os principais itens de custo incluindo categoria e preços realistas.',
  'collab.chat.template.packingOptimizer': 'Otimizador de Mala',
  'collab.chat.template.packingOptimizerPrompt': 'Gere uma lista de embalagem priorizada com base no clima, atividades e duração com quantidades.',
  'collab.chat.template.mapExpansion': 'Expansão do Mapa',
  'collab.chat.template.mapExpansionPrompt': 'Encontre 5 lugares adequados para esta viagem, priorize pela proximidade logística e adicione apenas candidatos significativos.',
  ...
  'notifications.count': '{count} notificação',
  'notifications.countPlural': '{count} notificações',
