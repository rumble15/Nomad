const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.user': 'SMTP Uživatel',
  'admin.smtp.pass': 'SMTP Heslo',
  'admin.smtp.from': 'Adresa odesílatele',
  'admin.smtp.skipTls': 'Přeskočit kontrolu TLS certifikátu',
  'admin.smtp.skipTlsHint': 'Zapněte pro vlastnoručně podepsané certifikáty na lokálních poštovních serverech',
  ...
  'login.inviteExpired': 'Neplatný nebo vypršelý odkaz na pozvánku',
  ...
  'admin.oidcDisplayNamePlaceholder': 'např. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'Discovery URL',
  'admin.oidcDiscoveryUrlOptional': 'Discovery URL (volitelné)',
  'admin.oidcDiscoveryUrlHint': 'Přepíše automaticky sestavenou Discovery URL. Potřebné pro poskytovatele jako Authentik.',
  ...
  'photos.count': '{count} fotografie',
  'photos.countPlural': '{count} fotografií',
  'photos.countFor': '{count} fotografií pro {trip}',
  ...
  'collab.chat.geminiExecute': 'Nechat Gemini provést',
  'collab.chat.geminiCommandHint': 'Gemini zahájí provádění po odeslání. Odpověz na zprávu, abys ji použil jako zdrojový nápad.',
  'collab.chat.template.dayFlow': 'Denní plán',
  'collab.chat.template.dayFlowPrompt': 'Naplánuj dnešní den jako přehledný harmonogram s časovými okny, místy a 1 záložní možností.',
  'collab.chat.template.budgetPass': 'Rozpočet',
  'collab.chat.template.budgetPassPrompt': 'Vytvoř kompaktní rozpočet s nejdůležitějšími nákladovými položkami včetně kategorie a realistických cen.',
  'collab.chat.template.packingOptimizer': 'Optimalizátor balení',
  'collab.chat.template.packingOptimizerPrompt': 'Vygeneruj prioritizovaný seznam balení na základě počasí, aktivit a délky s množstvím.',
  'collab.chat.template.mapExpansion': 'Rozšíření mapy',
  'collab.chat.template.mapExpansionPrompt': 'Najdi 5 vhodných míst pro tuto cestu, seřaď je podle logistické blízkosti a přidej jen smysluplné kandidáty.',
  ...
  'notifications.count': '{count} oznámení',
  'notifications.countPlural': '{count} oznámení',
