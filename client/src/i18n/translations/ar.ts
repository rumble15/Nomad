...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.host': 'خادم SMTP',
  'admin.smtp.port': 'منفذ SMTP',
  'admin.smtp.user': 'مستخدم SMTP',
  'admin.smtp.pass': 'كلمة مرور SMTP',
  'admin.smtp.from': 'عنوان المرسل',
  'admin.smtp.skipTls': 'تخطي فحص شهادة TLS',
  'admin.smtp.skipTlsHint': 'تفعيل للشهادات الموقعة ذاتياً على خوادم البريد المحلية',
  ...
  'login.inviteExpired': 'رابط الدعوة غير صالح أو منتهي الصلاحية',
  ...
  'admin.oidcDisplayNamePlaceholder': 'مثلاً Google، Authentik، Keycloak',
  'admin.oidcDiscoveryUrl': 'عنوان URL للاكتشاف',
  'admin.oidcDiscoveryUrlOptional': 'عنوان URL للاكتشاف (اختياري)',
  'admin.oidcDiscoveryUrlHint': 'تجاوز عنوان URL للاكتشاف المُنشأ تلقائيًا. مطلوب لمزودي الخدمة مثل Authentik.',
  ...
  'photos.countPlural': '{count} صور',
  'photos.countFor': '{count} صور لـ {trip}',
  'photos.linkDay': 'ربط اليوم',
  'photos.noDay': 'بلا يوم',
  'photos.captionForAll': 'تعليق (للكل)',
  ...
  'collab.chat.geminiExecute': 'دع Gemini يتولى التنفيذ',
  'collab.chat.geminiCommandHint': 'يبدأ تنفيذ Gemini بعد الإرسال. أجب على رسالة لاستخدامها كفكرة مصدر.',
  'collab.chat.template.dayFlow': 'خطة اليوم',
  'collab.chat.template.dayFlowPrompt': 'خطط لهذا اليوم كجدول واضح مع فترات زمنية وأماكن وخيار احتياطي واحد.',
  'collab.chat.template.budgetPass': 'الميزانية',
  'collab.chat.template.budgetPassPrompt': 'أنشئ ميزانية مدمجة بأهم بنود التكلفة بما يشمل الفئة والأسعار الواقعية.',
  'collab.chat.template.packingOptimizer': 'قائمة الأمتعة',
  'collab.chat.template.packingOptimizerPrompt': 'أنشئ قائمة تعبئة مُرتَّبة حسب الأولوية استناداً إلى الطقس والأنشطة والمدة مع الكميات.',
  'collab.chat.template.mapExpansion': 'توسيع الخريطة',
  'collab.chat.template.mapExpansionPrompt': 'ابحث عن 5 أماكن مناسبة لهذه الرحلة، وضعها حسب القرب اللوجستي وأضف المرشحين المنطقيين فقط.',
  ...
  'notifications.countPlural': '{count} إشعارات',
