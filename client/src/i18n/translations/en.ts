const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.pass': 'SMTP Password',
  'admin.smtp.from': 'From Address',
  ...
  'settings.mcp.gemini.model': 'Model',
  'settings.mcp.gemini.clientConfig': 'Gemini MCP Profile Template',
  'settings.mcp.gemini.clientConfigHint': 'Reference template for Gemini-compatible MCP clients. Property names can vary depending on the client.',
  'settings.mcp.gemini.alwaysOn': 'Always-On Co-Worker Prompt',
  'settings.mcp.gemini.alwaysOnHint': 'Use this as system instruction so Gemini can autonomously plan, optimize, and document your trip.',
  'settings.mcp.gemini.taskKickoff': 'Task Kickoff Prompt',
  'settings.mcp.gemini.taskKickoffHint': 'Paste this as a first task message to trigger end-to-end execution with function calling.',
  'settings.mcp.gemini.toolsHint': 'Recommended tools: get_trip_summary, maps_search, search_trip, plus create_*/update_*/delete_* tools for autonomous execution.',
  ...
  'login.inviteExpired': 'Invalid or expired invite link',
  ...
  'admin.oidcDiscoveryUrlHint': 'Override the auto-constructed discovery URL. Required for providers like Authentik where the endpoint is not at <issuer>/.well-known/openid-configuration.',
  ...
  // Photos
  'photos.title': 'Photos',
  'photos.count': '{count} photo',
  'photos.countPlural': '{count} photos',
  'photos.countFor': '{count} photos for {trip}',
  ...
  'collab.chat.geminiExecute': 'Let Gemini execute',
  'collab.chat.geminiCommandHint': 'Gemini execution starts after sending. Reply to a message to use it as source idea.',
  'collab.chat.template.dayFlow': 'Day Flow',
  'collab.chat.template.dayFlowPrompt': 'Plan today as a clear schedule with time slots, places, and 1 backup option.',
  'collab.chat.template.budgetPass': 'Budget Pass',
  'collab.chat.template.budgetPassPrompt': 'Create a compact budget with the most important cost items including category and realistic prices.',
  'collab.chat.template.packingOptimizer': 'Packing Optimizer',
  'collab.chat.template.packingOptimizerPrompt': 'Generate a prioritized packing list based on weather, activities, and duration with quantities.',
  'collab.chat.template.mapExpansion': 'Map Expansion',
  'collab.chat.template.mapExpansionPrompt': 'Find 5 suitable places for this trip, prioritize by logistical proximity and add only meaningful candidates.',
  ...
  'notifications.countPlural': '{count} notifications',
