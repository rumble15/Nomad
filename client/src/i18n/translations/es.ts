const es: Record<string, string> = {
  ...
  'admin.smtp.user': 'Usuario SMTP',
  'admin.smtp.pass': 'Contraseña SMTP',
  'admin.smtp.from': 'Dirección de remitente',
  'admin.smtp.skipTls': 'Omitir verificación de certificado TLS',
  'admin.smtp.skipTlsHint': 'Activar para certificados autofirmados en servidores de correo locales',
  ...
  'login.inviteExpired': 'Enlace de invitación no válido o expirado',
  ...
  'admin.oidcDisplayNamePlaceholder': 'ej. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'URL de descubrimiento',
  'admin.oidcDiscoveryUrlOptional': 'URL de descubrimiento (opcional)',
  'admin.oidcDiscoveryUrlHint': 'Anula la URL de descubrimiento construida automáticamente. Necesario para proveedores como Authentik.',
  ...
  'photos.captionForAll': 'Descripción (para todos)',
  'photos.captionPlaceholder': 'Descripción opcional...',
  ...
  'collab.chat.geminiExecute': 'Dejar que Gemini ejecute',
  'collab.chat.geminiCommandHint': 'La ejecución de Gemini comienza después de enviar. Responde a un mensaje para usarlo como idea de origen.',
  'collab.chat.template.dayFlow': 'Plan del Día',
  'collab.chat.template.dayFlowPrompt': 'Planifica el día de hoy como un horario claro con franjas horarias, lugares y 1 opción de respaldo.',
  'collab.chat.template.budgetPass': 'Presupuesto',
  'collab.chat.template.budgetPassPrompt': 'Crea un presupuesto compacto con los puntos de coste más importantes incluyendo categoría y precios realistas.',
  'collab.chat.template.packingOptimizer': 'Optimizador de Equipaje',
  'collab.chat.template.packingOptimizerPrompt': 'Genera una lista de equipaje priorizada según el clima, actividades y duración con cantidades.',
  'collab.chat.template.mapExpansion': 'Expansión del Mapa',
  'collab.chat.template.mapExpansionPrompt': 'Encuentra 5 lugares adecuados para este viaje, prioriza por proximidad logística y añade solo candidatos significativos.',
  ...
  'notifications.count': '{count} notificación',
  'notifications.countPlural': '{count} notificaciones',
