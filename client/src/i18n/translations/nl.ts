const nl: Record<string, string> = {
  ...
  'admin.smtp.port': 'SMTP Poort',
  'admin.smtp.user': 'SMTP Gebruiker',
  'admin.smtp.pass': 'SMTP Wachtwoord',
  'admin.smtp.from': 'Afzenderadres',
  'admin.smtp.skipTls': 'TLS-certificaatcontrole overslaan',
  'admin.smtp.skipTlsHint': 'Inschakelen voor zelfondertekende certificaten op lokale mailservers',
  ...
  'login.inviteExpired': 'Ongeldige of verlopen uitnodigingslink',
  ...
  'admin.oidcDisplayNamePlaceholder': 'bijv. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'Ontdekkings-URL',
  'admin.oidcDiscoveryUrlOptional': 'Ontdekkings-URL (optioneel)',
  'admin.oidcDiscoveryUrlHint': 'Overschrijft de automatisch opgebouwde ontdekkings-URL. Vereist voor providers zoals Authentik.',
  ...
  'photos.countPlural': '{count} foto\'s',
  'photos.countFor': '{count} foto\'s voor {trip}',
  'photos.linkDay': 'Dag koppelen',
  'photos.noDay': 'Geen dag',
  'photos.captionForAll': 'Bijschrift (voor iedereen)',
  ...
  'collab.chat.geminiExecute': 'Gemini laten uitvoeren',
  'collab.chat.geminiCommandHint': 'Gemini-uitvoering start na verzenden. Antwoord op een bericht om het als bronidee te gebruiken.',
  'collab.chat.template.dayFlow': 'Dagplanning',
  'collab.chat.template.dayFlowPrompt': 'Plan de dag van vandaag als een duidelijk schema met tijdvensters, plaatsen en 1 back-upoptie.',
  'collab.chat.template.budgetPass': 'Budget',
  'collab.chat.template.budgetPassPrompt': 'Maak een compact budget met de belangrijkste kostenposten inclusief categorie en realistische prijzen.',
  'collab.chat.template.packingOptimizer': 'Bagageoptimalisatie',
  'collab.chat.template.packingOptimizerPrompt': 'Genereer een geprioriteerde paklijst op basis van weer, activiteiten en duur met hoeveelheden.',
  'collab.chat.template.mapExpansion': 'Kaartuitbreiding',
  'collab.chat.template.mapExpansionPrompt': 'Vind 5 geschikte plaatsen voor deze reis, geef prioriteit op logistieke nabijheid en voeg alleen zinvolle kandidaten toe.',
  ...
  'notifications.count': '{count} melding',
  'notifications.countPlural': '{count} meldingen',
