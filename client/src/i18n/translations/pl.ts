const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.smtp.host': 'Serwer SMTP',
  'admin.smtp.port': 'Port SMTP',
  'admin.smtp.user': 'Użytkownik SMTP',
  'admin.smtp.pass': 'Hasło SMTP',
  'admin.smtp.from': 'Adres nadawcy',
  'admin.smtp.skipTls': 'Pomiń weryfikację certyfikatu TLS',
  'admin.smtp.skipTlsHint': 'Włącz dla certyfikatów samopodpisanych na lokalnych serwerach pocztowych',
  ...
  'login.inviteExpired': 'Nieprawidłowy lub wygasły link zaproszenia',
  ...
  'admin.oidcDisplayNamePlaceholder': 'np. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'URL odkrycia',
  'admin.oidcDiscoveryUrlOptional': 'URL odkrycia (opcjonalny)',
  'admin.oidcDiscoveryUrlHint': 'Zastępuje automatycznie zbudowany URL odkrycia. Wymagane dla dostawców takich jak Authentik.',
  ...
  'photos.count': '{count} zdjęcie',
  'photos.countPlural': '{count} zdjęć',
  'photos.countFor': '{count} zdjęć dla {trip}',
  'photos.linkDay': 'Powiąż dzień',
  ...
  'collab.chat.geminiExecute': 'Pozwól Gemini wykonać',
  'collab.chat.geminiCommandHint': 'Wykonanie Gemini rozpoczyna się po wysłaniu. Odpowiedz na wiadomość, aby użyć jej jako pomysłu źródłowego.',
  'collab.chat.template.dayFlow': 'Plan dnia',
  'collab.chat.template.dayFlowPrompt': 'Zaplanuj dzisiejszy dzień jako czytelny harmonogram z przedziałami czasowymi, miejscami i 1 opcją zapasową.',
  'collab.chat.template.budgetPass': 'Budżet',
  'collab.chat.template.budgetPassPrompt': 'Stwórz kompaktowy budżet z najważniejszymi pozycjami kosztów, kategorią i realistycznymi cenami.',
  'collab.chat.template.packingOptimizer': 'Optymalizator pakowania',
  'collab.chat.template.packingOptimizerPrompt': 'Wygeneruj priorytetową listę pakowania na podstawie pogody, aktywności i czasu trwania z ilościami.',
  'collab.chat.template.mapExpansion': 'Rozszerzenie mapy',
  'collab.chat.template.mapExpansionPrompt': 'Znajdź 5 odpowiednich miejsc na tę podróż, priorytetyzuj według bliskości logistycznej i dodaj tylko sensownych kandydatów.',
  ...
  'inspector.activities': 'Aktywności',
  'inspector.activitiesGenerate': 'Zaplanuj aktywności',
  'inspector.activitiesGenerating': 'Generowanie planu aktywności…',
  'inspector.activitiesError': 'Nie można wygenerować planu aktywności.',
  'inspector.activitiesRetry': 'Spróbuj ponownie',
  'inspector.activitiesHide': 'Ukryj',
  ...
  'notifications.count': '{count} powiadomienie',
  'notifications.countPlural': '{count} powiadomień',
